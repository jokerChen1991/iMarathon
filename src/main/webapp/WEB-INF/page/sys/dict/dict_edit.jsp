...
<html lang="zh-CN">
	...
	<body>
		<form id="dictEditForm" class="form-horizontal col-sm-12" 
			style="padding: 30px 0 10px 0;">
			
			<input type="hidden" value="${dict.id}" name="id" id="dictId">
			<input type="hidden" value="${dict.sortCode}" name="sortCode" id="sortCode">
			<input type="hidden" value="${dict.status}" name="status" id="status">
