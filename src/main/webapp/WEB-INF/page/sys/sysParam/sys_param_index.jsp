...
<html lang="zh-CN">
	...
	<body>
		<div class="jqgrid-container-sm jqgrid-container-xs row" style="border: 1px solid #ddd;margin-bottom: 5px;">
			<form id="sysParamQueryForm">
				<div class="col-sm-4 col-xs-12" style="padding:5px 0 0px 0;">
					<label class="lable-for-input" style="float:left;padding:8px;">参数编码 : </label>
					<div class="col-xs-9">
					<input class="form-control" name="code" 
						type="text" placeholder="参数编码"/>
					</div>
				</div>
				<div class="col-sm-4 col-xs-12" style="padding:5px 0 0px 0;">
					<label class="lable-for-input" style="float: left;padding:8px;">参数名称: </label>
					<div class="col-xs-9">
						<input type="text" class="form-control"
							placeholder="参数名称" name="name" >
					</div>
				</div>
				<div class="col-sm-4 col-xs-12" style="padding:5px 0 0px 0;">
					<input type="button" class="btn col-xs-4 col-sm-2" 
						style="float:right;" value="查询" onclick="querySysParam()">
				</div>
			</form>
		</div>
	
		<div class="jqgrid-container-sm jqgrid-container-xs">
		    <table id="sysParamJqGrid"></table>
	    ...
	    <script src="${contextPath}/ui/jqGrid/js/jquery.jqGrid.min.js"
			type="text/javascript" charset="utf-8"></script>
		<script src="${contextPath}/ui/sys/sysParam.js" type="text/javascript"></script>
