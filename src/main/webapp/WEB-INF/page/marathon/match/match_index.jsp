...
<html lang="zh-CN">
	...
	<body>
			...
			<form id="matchQueryForm">
				<div class="col-sm-4 col-xs-12" style="padding:5px 0 0px 0;">
					...
					<input class="form-control" name="matchName"
						value="${match.matchName}" type="text" placeholder="matchname"/>
					</div>
				</div>
				<div class="col-sm-4 col-xs-12" style="padding:5px 0 0px 0;">
					<label class="lable-for-input" style="float: left;padding:8px;">昵&nbsp;&nbsp;&nbsp;称 : </label>
					<div class="col-xs-9">
						<input type="text" class="form-control" value="${match.nickname}"
	    ...
	    <script src="${contextPath}/ui/jqGrid/js/jquery.jqGrid.min.js"
			type="text/javascript" charset="utf-8"></script>
		<script src="${contextPath}/ui/marathon/match.js" type="text/javascript"></script>
